 ...
 */
public class CustomerViewText02 extends View {
    private static final String TEXT = "apodSen森ξτβбпшㄎㄊ";
    private Paint textPaint, linePaint;// 文本的画笔和中心线的画笔

    private int baseX, baseY;// Baseline绘制的XY坐标

    public CustomerViewText02(Context context) {
        this(context, null);
    }

    public CustomerViewText02(Context context, AttributeSet attrs) {
        super(context, attrs);
