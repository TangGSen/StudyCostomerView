 ...
 */
public class ShaderView02 extends View {
    ...
    public ShaderView02(Context context) {
        super(context);
    }

    public ShaderView02(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 初始化画笔
        initPaint();
    ...
    private void initPaint() {
         ...
         * 生成BitmapShader
         */
        Bitmap mBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.test3);
